...
namespace CRM_project.Controllers
{
    public class TeacherAndSubjectsController : Controller
    {
        ...
        public TeacherAndSubjectsController(CRM_projectContext context)
        {
            _context = context;
        }
        ...
        {
            var cRM_projectContext = _context.TeacherAndSubject.Include(t => t.Subject).Include(t => t.Teacher);
